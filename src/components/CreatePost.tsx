	...
	return <div className='bg-white mb-1'>
		...
		<div ref={modal} className='hidden z-50 fixed w-full h-full top-0 left-0'>
			...
			<div className='z-20 w-[800px] mx-auto top-12 relative bg-white p-5 rounded'>
				<h1></h1>
				<textarea onChange={event => setContent(event.target.value)} className='rounded w-full min-h-[200px] hover:outline-blue-600 outline-0 p-2 resize-none'/>
				...
				<div className='mt-2 border-t-2 flex flex-col gap-1'>
					...
					<div className='flex flex-row gap-2 justify-end'>
						<button onClick={gui} className='flex-1 rounded bg-blue-300 p-1 text-white font-extrabold hover:duration-300 duration-150 hover:bg-blue-500'>Gửi
						</button>
